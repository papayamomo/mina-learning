...
public interface IoAcceptor extends IoService {
	 ...
	 * to accept incoming connections. All managed connections will be closed if
	 * {@link #setCloseOnDeactivation(boolean) disconnectOnUnbind} property is
	 * <tt>true</tt>. This method returns silently if no local address is bound
	 * yet.
	 */
	void unbind();
